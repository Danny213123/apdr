...
def write_output_file(
    ...
    content = [
        ...
        f"docker_plan_status: {summary.get('DOCKER_PLAN_STATUS', '')}",
        f"docker_plan_path: {summary.get('DOCKER_PLAN_PATH', '')}",
        f"docker_plan_authorship: {summary.get('DOCKER_PLAN_AUTHORSHIP', '')}",
        f"docker_plan_fallback_sections: {summary.get('DOCKER_PLAN_FALLBACK_SECTIONS', '')}",
        f"authored_dockerfile_path: {summary.get('AUTHORED_DOCKERFILE_PATH', '')}",
        ...
        f"executed_dockerfile_path: {summary.get('EXECUTED_DOCKERFILE_PATH', '')}",
        f"docker_build_command_path: {summary.get('DOCKER_BUILD_COMMAND_PATH', '')}",
        f"docker_run_command_path: {summary.get('DOCKER_RUN_COMMAND_PATH', '')}",
        f"executed_image_ref: {summary.get('EXECUTED_IMAGE_REF', '')}",
        f"image_handoff_verified: {summary.get('IMAGE_HANDOFF_VERIFIED', 'false')}",
        f"image_inspect_path: {summary.get('IMAGE_INSPECT_PATH', '')}",
